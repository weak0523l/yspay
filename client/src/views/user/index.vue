<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="80px">
	  ...
	  <el-from-item>
		  <div align="center">
			  <el-button type="primary" v-waves @click="editData()" icon="el-icon-edit" style="width: 100%;">修改密码</el-button>
		  </div>
	  </el-from-item>
    </el-form>
	    ...
	    <el-row :gutter="100">
	      <el-col :lg="24">
	        <el-form-item label="请确认" prop="newPwds">
	          <el-input v-model="editForm.newPwds" placeholder="请再次输入新密码" type="password" >
			  </el-input>
	        </el-form-item>
	      </el-col>
	    </el-row>
    ...
    data() {
		...
		var checkPassword = ((rule, value, callback) => {
			if (this.editForm.newPwd == '') {
				...
				if(this.editForm.newPwd.length < 3){
					return callback(new Error('密码长度至少要3位'));
				}
				callback();
			}
		});
