        ...
        <el-row :gutter="100">
          <el-col :lg="24">
            <el-form-item label="账号等级" prop="isroot">
              <el-select v-model="editForm.isroot" placeholder="请选择账号等级" style="width: 100%;" @change="selectRole(editForm.isroot)">
        ...
        <el-row :gutter="100" >
          <el-col :lg="24" >
            <el-form-item label="所属机构" prop="rootid">
              <el-select v-model="editForm.rootid" placeholder="请选择所属机构(账号等级为管理员时不用选择)" style="width: 100%;">
                  <el-option 
                    v-for="item in clubList"
                    :key="item.id"
                    :label="item.clubname"
