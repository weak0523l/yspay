	   ...
	   <el-row>
	       ...
	       <el-col :lg="8">
	         <div class="demo-image__preview" style="padding-left: 10px;padding-top: 4px;">
	           <img  @click="getcode()" style="width: 138px;height: 45px;" v-bind:src="img" >
	         </div>
	       </el-col>
	   </el-row>
...
export default {
  ...
  data () {
    ...
    return {
	  img: 'http://127.0.0.1:8080/pay/user/getcode',
      loginForm: {
        userName: "",
        password: "",
		code:""
  ...
  methods: {
	  ...
	  getcode(){
		  this.img="http://127.0.0.1:8080/pay/user/getcode?"+Math.random();
	  },
