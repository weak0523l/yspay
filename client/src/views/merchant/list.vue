<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
      ...
      <el-table-column label="统一收单账号" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="最后一笔交易时间" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.lastpaytime }}</span>
        </template>
      </el-table-column>
	...
	<!-- 	<el-row :gutter="100">
		  <el-col :lg="24">
		    <el-form-item label="上传证书">
		      <el-upload
		        class="upload-demo"
		        action="http://127.0.0.1:8080/pay/merchant/uploadFile"
    	...
    	<!-- <el-row :gutter="100">
    	  <el-col :lg="24">
    	    <el-form-item label="最后交易时间">
    	      <el-input v-model="editForm.lastpaytime" placeholder="" ></el-input>
    	    </el-form-item>
    	  </el-col>
    	</el-row> -->
    		
    	<!-- <el-row :gutter="100" v-if=" isroot == 1 ||  isroot == 2">
    	  <el-col :lg="24">
    	    <el-form-item label="所属行社:">
    	        <el-select v-model="editForm.clubname" @change="clubChange();" style="width: 100%;" filterable  placeholder="请选择行社">
    	          <el-option
    	                    v-for="item in editForm.clublist"
    	                    :key="item.id"
    	                    :label="item.clubname"
    	                    :value="item.id">
    	          </el-option>
    	  ...
    	  <el-col :lg="24">
    	    <el-form-item label="所属网点:">
    	        <el-select v-model="editForm.branchid" style="width: 100%;" filterable  placeholder="请选择网点">
    	          <el-option
    	                    v-for="item in editForm.branchlist"
    	                    :key="item.id"
