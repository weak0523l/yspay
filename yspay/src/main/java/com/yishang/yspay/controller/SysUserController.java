...
public class SysUserController {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        jedis.setex("code:" + currentIp, 3 * 60, randomCode.toString());
    ...
    public R login(@RequestBody Map<String, String> params, HttpServletRequest request) {
        ...
        Jedis jedis = redisUtil.getJedis();
        String getcode = jedis.get("code:" + currentIp);
    ...
    public R getUserInfo() {
        ...
        List<SysMenu> list = sysMenuService.listByIds(menuids);
    ...
    public R selectRole(@RequestBody Map<String, String> params) {
        ...
        if (isroot.equals("4")) {
            ...
            if (user.getIsroot() == 2) {
                ...
                return R.ok().put("merchList2", merchList2);
            }
            if (user.getIsroot() == 1) {
...
/*            if (user.getIsroot() == 4) {
    ...
    public R resetPassword(@RequestBody Map<String, String> params) {
        ...
        sysUser.setPassword(DigestUtils.md5Hex("123"));
        sysUserService.updateById(sysUser);
        return R.ok("密码重置成功！");
    }
}
