...
public class PayBranchController {
    ...
    public R edit(@RequestBody PayBranch payBranch){
        ...
        if(payBranch.getId() ==null || StringUtils.isBlank(payBranch.getId())){
            ...
            payBranch.setPrincipal(payBranch.getPrincipal());
            payBranch.setPhone(payBranch.getPhone());
            payBranch.setMessage(payBranch.getMessage());
            payBranch.setClubid(payBranch.getClubid());
